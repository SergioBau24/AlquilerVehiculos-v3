...
public class Cliente {
	...
	private boolean comprobarLetraDni(String dni) {
		...
		int id = Integer.parseInt(dni.substring(0, 8));

		resto = id % 23;

		if (letrasDni[resto] == dni.charAt(8)) {
	...
	public String toString() {
		return String.format("%s - %s (%s)", nombre, dni, telefono); // Cada s corresponde a una variable
	}
